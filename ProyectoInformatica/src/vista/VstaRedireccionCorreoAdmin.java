 ...
 * @author ACER
 */
public class VstaRedireccionCorreoAdmin extends javax.swing.JFrame {

    /**
     * Creates new form VstaRedireccionCorreoAdmin
     */
    public VstaRedireccionCorreoAdmin() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setName("Recuperar Contraseña1 - Administrador"); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VstaRedireccionCorreoAdmin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VstaRedireccionCorreoAdmin().setVisible(true);
            }
        });
    }
