 ...
 * @author ACER
 */
public class VstaEdicioDatosAdmin extends javax.swing.JFrame {

    /**
     * Creates new form EdicioDatos
     */
    public VstaEdicioDatosAdmin() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Edición De DatosPersonales - Administrador");
        setName("Edición De DatosPersonales - Administrador"); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VstaEdicioDatosAdmin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VstaEdicioDatosAdmin().setVisible(true);
            }
        });
    }
