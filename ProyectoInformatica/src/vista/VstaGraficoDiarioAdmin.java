 ...
 * @author ACER
 */
public class VstaGraficoDiarioAdmin extends javax.swing.JFrame {

    /**
     * Creates new form VstaGraficoSemanalesAdmin
     */
    public VstaGraficoDiarioAdmin() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Tipos De Comidas Más Frecuentes - Administrador");
        setName("Tipos De Comidas Más Frecuentes - Administrador"); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VstaGraficoDiarioAdmin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VstaGraficoDiarioAdmin().setVisible(true);
            }
        });
    }
