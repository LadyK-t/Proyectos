 ...
 * @author ACER
 */
public class VstaListarMenuAdmin extends javax.swing.JFrame {

    /**
     * Creates new form VstaListarMenuAdmin
     */
    public VstaListarMenuAdmin() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Listar Menú - Administrador");
        setName("Listar Menú - Administrador"); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VstaListarMenuAdmin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VstaListarMenuAdmin().setVisible(true);
            }
        });
    }
