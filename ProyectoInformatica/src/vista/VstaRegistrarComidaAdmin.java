 ...
 * @author ACER
 */
public class VstaRegistrarComidaAdmin extends javax.swing.JFrame {

    /**
     * Creates new form VstaRegistrarComidaAdmin
     */
    public VstaRegistrarComidaAdmin() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Registrar Comida - Administrador");
        setName("Registrar Comida - Administrador"); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VstaRegistrarComidaAdmin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VstaRegistrarComidaAdmin().setVisible(true);
            }
        });
    }
