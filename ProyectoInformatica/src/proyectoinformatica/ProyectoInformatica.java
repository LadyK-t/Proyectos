 ...
 */
package proyectoinformatica;

import vista.VstaEdicioDatosAdmin;
import vista.VstaGraficoDiarioAdmin;
import vista.VstaInicioAdmin;
import vista.VstaListarMenuAdmin;
import vista.VstaModificarComidaAdmin;
import vista.VstaRanquinSemanalAdmin;
import vista.VstaRecuperarContrasenaAdmin;
import vista.VstaRedireccionCorreoAdmin;
import vista.VstaRegistrarComidaAdmin;

/**
 *
 * @author ACER
 */
public class ProyectoInformatica {
    ...
    public static void main(String[] args) {
        ...
        vtnMenuPrincipal4.setVisible(true);
        VstaRanquinSemanalAdmin vtnMenuPrincipal5= new VstaRanquinSemanalAdmin();
        vtnMenuPrincipal5.setVisible(true);
        VstaRecuperarContrasenaAdmin vtnMenuPrincipal6= new VstaRecuperarContrasenaAdmin();
        vtnMenuPrincipal6.setVisible(true);
